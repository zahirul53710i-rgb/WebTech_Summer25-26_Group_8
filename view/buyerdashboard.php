            ...
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>20</td>
                        <td>
                            <input type="hidden" name="product" value="Medicine A">
                            <input type="number" id="quantity" name="quantity" placeholder="Quantity" min="1">
                            <br>
                            <?php echo isset($message) ? '<span class="message">' . $message . '</span>' : ""; ?>
                    ...
                    <tr>
                        ...
                        <td>15</td>
                        <td>
                            <input type="button" value="Buy" onclick="location.href='cart.php'">
                        </td>
                    </tr>
                ...
                <div class="link">
                    <a href="buyer_profile_view_update.php">My Profile</a>
